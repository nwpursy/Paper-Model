...
from CMTS_for_water.Sublayers import Inception_Temporal_Layer
from CMTS_for_water.Fusion import FusionLayer
from CMTS_for_water import Const
from CMTS_for_water.UniVariateSeq2Seq import UniVariateSeq2Seq
...
if __name__ == '__main__':
    ...
    # result=model.evaluate(da.train_filtered_seq,20)
    print(result.size())
